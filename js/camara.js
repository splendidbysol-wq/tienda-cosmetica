 ...
 * @param {File} archivo - archivo de imagen original (de la cámara)
 * @param {number} anchoMaximo - ancho máximo en píxeles (alto se ajusta proporcional)
 * @param {number} calidad - 0 a 1 (0.7-0.8 es buen balance calidad/peso)
 * @returns {Promise<Blob>} imagen comprimida en formato JPEG
 */
export function comprimirImagen(archivo, anchoMaximo = 800, calidad = 0.75) {
